...
export default function MentionsLegalesPage() {
  return (
    <Wrapper>
      ...
      <h1>Identité</h1>
      <p>
        Nom du site web : Algir <br />
        Adresse du site : https://algir.fr/ <br />
        Propriétaire : Alice Girard <br />
        Responsable de publication : Alice Girard - mail <br />
        Hébergement : Gatsby Hosting
      </p>
      <h1>Entrepreneur individuel</h1>
      <p>Alice Girard - RCS - TVA - téléphone - email - adresse postale</p>
      ...
      <p>
        ...
        sans de caractère exhaustif, et ne peuvent engager la responsabilité du
      ...
      <h1>Interactivité</h1>
      <p>
        Les utilisateurs du site peuvent y déposer du contenu, apparaissant sur
        le site dans des espaces dédiés (notamment via les commentaires). Le
        contenu déposé reste sous la responsabilité de leurs auteurs, qui en
        assument pleinement l’entière responsabilité juridique. <br />
      ...
      <p>
        ...
        restent la propriété exclusive de leurs auteurs, en ce qui concerne les
        droits de propriété intellectuelle ou les droits d’usage. <br /> Toute
        ...
        l’auteur.
        <br /> Toute exploitation non autorisée du site ou de l’un quelconque
        des éléments qu’il contient est considérée comme constitutive d’une
        contrefaçon et passible de poursuites. <br /> Les marques et logos
        reproduits sur le site sont déposés par les sociétés qui en sont
        propriétaires.
      </p>
      <h1>Liens</h1>
      <h2>Liens sortants</h2>
      <p>
        Le propriétaire du site décline toute responsabilité et n’est pas engagé
        par le référencement via des liens hypertextes, de ressources tierces
        présentes sur le réseau Internet, tant en ce qui concerne leur contenu
        que leur pertinence.
      </p>
      ...
      <p>
        ...
        demande écrite et signée, accompagnée d’une preuve d’identité. <br /> Le
        site ne recueille pas d’informations personnelles, et n’est pas
        assujetti à déclaration à la CNIL. (Remplacé par les disposition de la
        RGPD)
      </p>
      <h1>Crédits</h1>
      <p>crédits photo, icones, etc.</p>
      <p>
        Mentions légales fournies par WebExpress – Version 2.2 – Utilisation
        libre sous Licence Creative Commons CC BY-NC-ND 3.0 FR /
        creativecommons.org.
      </p>
      <ol>
        <li>
          Articles L111-1 et suivants du Code de la Propriété Intellectuelle du
          1er juillet 1992
        </li>
        ...
        <li>
          Loi du 1er juillet 1998 transposant la directive 96/9 du 11 mars 1996
